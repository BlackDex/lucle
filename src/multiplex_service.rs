...
impl<A, B> Service<Request<hyper::body::Incoming>> for MultiplexService<A, B>
where
    A: Service<Request<hyper::body::Incoming>, Error = Infallible>,
    A::Response: IntoResponse,
    A::Future: Send + 'static,
    B: Service<Request<hyper::body::Incoming>>,
