 ...
 */
export class RepositoryPath extends Message$1<RepositoryPath> {
  /**
 ...
 */
export class ResponseResult extends Message$1<ResponseResult> {
  /**
 ...
 */
export class StatusResult extends Message$1<StatusResult> {
  /**
 ...
 */
export class Version extends Message$1<Version> {
  /**
   * @generated from field: string path = 1;
   */
  path = "";
 ...
 */
export class Package extends Message$1<Package> {
  /**
   * @generated from field: string path = 1;
   */
  path = "";
 ...
 */
export class Database extends Message$1<Database> {
  /**
...
/**
 * @generated from message luclerpc.Message
 */
export class Message extends Message$1<Message> {
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "luclerpc.Message";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
